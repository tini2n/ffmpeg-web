...
// include: /Users/tini2n/Projects/playground/wasm/FFmpeg/pre.js
var Module = {
  print: function(text) {
...
/** @param {boolean=} dontAddNull */ var writeAsciiToMemory = (str, buffer, dontAddNull) => {
  ...
  // Null-terminate the string
  if (!dontAddNull) GROWABLE_HEAP_I8()[buffer] = 0;
};
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall__newselect, ___syscall_faccessat, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_newfstatat, ___syscall_openat, ___syscall_renameat, ___syscall_rmdir, ___syscall_stat64, ___syscall_unlinkat, __mmap_js, __munmap_js, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_write ];
...
var dynCall_iiijjji = Module["dynCall_iiijjji"] = createExportWrapper("dynCall_iiijjji", 10);

var dynCall_iiiji = Module["dynCall_iiiji"] = createExportWrapper("dynCall_iiiji", 6);

var dynCall_jiiij = Module["dynCall_jiiij"] = createExportWrapper("dynCall_jiiij", 6);
...
var _ff_h264_cabac_tables = Module["_ff_h264_cabac_tables"] = 1022444;
