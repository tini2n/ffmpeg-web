...
// end include: preamble.js
  ...
  var SYSCALLS = {DEFAULT_POLLMASK:5,calculateAt:function(dirfd, path, allowEmpty) {
        ...
        HEAP32[(((buf)+(8))>>2)] = stat.ino;checkInt32(stat.ino);
        HEAP32[(((buf)+(12))>>2)] = stat.mode;checkInt32(stat.mode);
        HEAPU32[(((buf)+(16))>>2)] = stat.nlink;checkInt32(stat.nlink);
        HEAP32[(((buf)+(20))>>2)] = stat.uid;checkInt32(stat.uid);
        HEAP32[(((buf)+(24))>>2)] = stat.gid;checkInt32(stat.gid);
        HEAP32[(((buf)+(28))>>2)] = stat.rdev;checkInt32(stat.rdev);
        HEAP64[(((buf)+(40))>>3)] = BigInt(stat.size);checkInt64(stat.size);
        HEAP32[(((buf)+(48))>>2)] = 4096;checkInt32(4096);
        HEAP32[(((buf)+(52))>>2)] = stat.blocks;checkInt32(stat.blocks);
        var atime = stat.atime.getTime();
        var mtime = stat.mtime.getTime();
        var ctime = stat.ctime.getTime();
        HEAP64[(((buf)+(56))>>3)] = BigInt(Math.floor(atime / 1000));checkInt64(Math.floor(atime / 1000));
        HEAPU32[(((buf)+(64))>>2)] = (atime % 1000) * 1000;checkInt32((atime % 1000) * 1000);
        HEAP64[(((buf)+(72))>>3)] = BigInt(Math.floor(mtime / 1000));checkInt64(Math.floor(mtime / 1000));
        HEAPU32[(((buf)+(80))>>2)] = (mtime % 1000) * 1000;checkInt32((mtime % 1000) * 1000);
        HEAP64[(((buf)+(88))>>3)] = BigInt(Math.floor(ctime / 1000));checkInt64(Math.floor(ctime / 1000));
        HEAPU32[(((buf)+(96))>>2)] = (ctime % 1000) * 1000;checkInt32((ctime % 1000) * 1000);
        HEAP64[(((buf)+(104))>>3)] = BigInt(stat.ino);checkInt64(stat.ino);
        return 0;
  ...
  try {
      ...
      if (readfds) {
        HEAP32[((readfds)>>2)] = dstReadLow;checkInt32(dstReadLow);
        HEAP32[(((readfds)+(4))>>2)] = dstReadHigh;checkInt32(dstReadHigh);
      }
      if (writefds) {
        HEAP32[((writefds)>>2)] = dstWriteLow;checkInt32(dstWriteLow);
        HEAP32[(((writefds)+(4))>>2)] = dstWriteHigh;checkInt32(dstWriteHigh);
      }
      if (exceptfds) {
        HEAP32[((exceptfds)>>2)] = dstExceptLow;checkInt32(dstExceptLow);
        HEAP32[(((exceptfds)+(4))>>2)] = dstExceptHigh;checkInt32(dstExceptHigh);
      }
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 86858188;
